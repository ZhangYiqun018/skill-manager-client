...
pub use index::{
    ...
    default_repo_cache_path, default_store_path, diff_skill_directories, import_git_skill,
    import_skill_directory, install_managed_skill, load_custom_targets, load_discovery_report,
    load_install_target_inventory, load_managed_git_source, load_managed_skill_history,
    load_managed_skill_origins, load_skill_file_tree, load_skill_index,
