...
pub use index::{
    IndexError, add_custom_target, adopt_skill, adopt_skills, apply_adoption_resolutions,
    check_managed_skill_updates, compare_skills, default_data_root, default_index_path,
    default_repo_cache_path, default_store_path, diff_skill_directories, export_skills_by_tags,
    import_git_skill, import_skill_directory, install_managed_skill, load_custom_targets,
    load_discovery_report, load_install_target_inventory, load_managed_git_source,
    ...
    refresh_skill_index, remove_custom_target, remove_managed_skill_install, repair_install_target,
    repair_managed_skill_install, set_skill_tags, sync_install_target,
    update_managed_skill_from_git, update_managed_skill_variant_label,
};
pub use models::{
